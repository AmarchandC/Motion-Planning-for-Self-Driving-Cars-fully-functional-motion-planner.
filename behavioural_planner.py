...
class BehaviouralPlanner:
    ...
    def transition_state(self, waypoints, ego_state, closed_loop_speed):
        ...
        if self._state == FOLLOW_LANE:
            ...
            # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
            # ------------------------------------------------------------------
            updated_goal_index, stop_sign_found = self.check_for_stop_signs(waypoints, closest_index, goal_index)
            self._goal_index = updated_goal_index if stop_sign_found else goal_index
            self._goal_state = waypoints[self.goal_index]
            # ------------------------------------------------------------------
    ...
    def get_goal_index(self, waypoints, ego_state, closest_len, closest_index):
        ...
        while wp_index < len(waypoints) - 1:
            wp_index += 1
            arc_length += math.sqrt((waypoints[wp_index][1]-waypoints[wp_index-1][1])**2 + (waypoints[wp_index][0]-waypoints[wp_index-1][0])**2)
